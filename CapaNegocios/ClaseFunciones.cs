...
namespace CapaNegocios
{
    public class ClaseFunciones
    {
        ...
        private static List<Unidades> TheUnidades = new List<Unidades>();
        ...
        static void EditarUnidad()
        {
            try
            {
                ...
                foreach (Unidades item in TheUnidades)
                {
        ...
        static void EliminarUnidad()
        {
            try
            {
                ...
                int seleccion = Convert.ToInt32(Console.ReadLine());
                foreach (Unidades m in TheUnidades)
                {

                    if (seleccion == m.Matricula)
                    {
                        Console.Clear();
                        TheUnidades.RemoveAll(i => i.Matricula == seleccion);
                        menu();
                    }
        ...
        static void AsignarAutAChofer()
        {
            try
            {
                ...
                foreach (Choferes item1 in TheChoferes)
                {
                    ...
                    {
                        foreach (Unidades item2 in TheUnidades)
                        {
                            Console.WriteLine("                    Unidad:" +
                        ...
                        foreach (Unidades item3 in TheUnidades)
                        {
